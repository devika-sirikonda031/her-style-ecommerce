...
function CategorySection() {
 ...
 const categories = [
  { name: "skirts", label: "Skirts", image: skirtImg },
  { name: "tops", label: "Tops", image: topImg },
  { name: "trousers", label: "Trousers", image: trouserImg },
  { name: "dresses", label: "Dresses", image: dressImg },
];
